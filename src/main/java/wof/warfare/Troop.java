...
public enum Troop {
    ...
    SWORDSMAN   (135, 40, 40, 50, 2800, 1,true, false, UnitType.INFANTRY, SWORDSMAN_ABILITIES),
    HALBERD     (80, 35, 70, 60, 3500, 2, true, false, UnitType.INFANTRY, HALBERD_ABILITIES),
    SPEARMAN    (80, 25, 70,50, 1800, 3, true, false, UnitType.INFANTRY, SPEARMAN_ABILITIES),
    KNIGHT      (190, 50, 60, 80, 4500, 1, true, false, UnitType.HORSEMAN, KNIGHT_ABILITIES),
